...
const story = {
    ...
    scene_3_cutscene: {
        text: "เมื่อคุณลืมตาขึ้นมาอีกครั้ง คุณกลับเห็นเพดานห้องสีขาว ตัวคุณนอนราบอยู่บนเตียง ขยำเสื้อตัวเองจนแทบจิกเข้าเนื้อ- \nเหงื่อกาฬคุณไหลซึมจนเปียกชื้น คุณค่อย ๆ หยัดกายลุกขึ้นเชื่องช้า",
        background : "",
        next: "scene_4"
    },

    scene_4: {
        text: "ภาพตรงหน้าเรียกได้ว่าเป็นห้องนอนห้องหนึ่ง คุณกวาดสายตามองไปรอบ ๆ ความคุ้นเคยที่เพิ่มขึ้นทีละน้อยทำให้คุณมั่นใจ- \nไม่ผิดแน่ นี่คือห้องของพ่อแม่คุณ, ห้องที่คุณไม่ได้รับอนุญาตให้เข้ามาได้โดยง่าย ห้องที่คุณจำต้องแอบเข้ามาอย่างเงียบเชียบ \nแต่ความทรงจำที่เลือนรางกลับชวนให้คุณรู้สึกว่ามันประหลาด ...",
        background : "",
        character: "",
        delay_character : 0,
    ...
    explore_1: {
        text: "คุณตัดสินใจทำลายความสงสัยด้วยการสำรวจ เช่นวัยอยากรู้อยากเห็น- เพียงแต่มีจังหวะชีพจรที่อาจถูกพรากไปได้ทุกเมื่อเข้ามาเกี่ยวข้องเท่านั้น, \nคุณกวาดสายตา มือไล่ไปตามตู้เตียง ทุกอย่างดูปกติ เว้นเสียแต่สมุดเล่มหนึ่งที่วางเด่นกลางโต๊ะไม้ \nสภาพมันคล้ายใกล้จะพังเต็มที คุณหยิบมันขึ้นมา",
        background : "",
        next: "explore_2"
    },

    explore_2: {
        text: "หน้าสมุดมีรอยเปรอะเปื้อนสีน้ำตาลเข้ม คุณใช้ปลายนิ้วลูบผ่าน มันแห้งกรัง- จำเป็นจับมันด้วยสองมือเพื่อเปิดอ่าน \nภายในมีเพียงรูปภาพจาง ๆ หนึ่งรูปและข้อความที่คล้ายประวัติส่วนตัว หน้ากระดาษบางส่วนขาดหายไป",
        background : "",
        next: "explore_3"
    },

    explore_3: {
        text: "คุณใช้เวลาในการอ่านราวหลายนาที เนื้อหาในนั้นไม่ต่างจากสมุดบันทึกทั่วไปที่คุณพอจะคาดเดาได้ ทอดถอนหายใจก่อนเงยหน้าขึ้นมา ประตูห้องอยู่ตรงหน้าคุณ- \nแม้จะยังสับสน แต่หากไม่ออกไปข้างนอกคงได้ติดอยู่ในห้องนี้ตลอดไปแน่",
        background : "",
        character: "",
        delay_character : 0,
        next: "explore_4"
    ...
    explore_4: {
        text: "คุณก้าวขาออกมาด้านนอก ภาพตรงหน้าคือทางเดินทอดยาวไปสุดปลายทางอันคือห้องนอนคุณเอง \nแต่ระหว่างนั้นจำต้องผ่านห้องหนึ่งไปก่อน ทว่าเมื่อคุณลองเปิดประตูกลับพบว่ามันถูกล็อคเอาไว้ คุณขมวดคิ้วอย่างฉงน- \nทางเลือกถูกตัดออกไป ตอนนี้คุณจึงยืนอยู่หน้าห้องนอนของคุณ \nเสียงกุกกักด้านในดังลอดผ่านมาให้คุณได้ยิน ฝ่ามือคุณชะงัก พลันหันมองไปยังบันไดข้าง ๆ",
        background : "",
        character: "",
        delay_character : 0,
    ...
    explore_opendoor_cutscence: {
        text: "คุณกลั้นใจผลักบานประตูเข้าไป ภาพตรงหน้าคือแสงจันทร์สาดกระทบลงบนเรือนร่างหญิงสาว เธอใส่ชุดสีขาวนวล \nเมื่อคุณเลื่อนสายตาขึ้นสบ จึงได้พบกับพี่สาวที่ยิ้มให้คุณอย่างอ่อนโยน ...",
        background : "",
        next: ""
    },

    explore_downstair: {
        text: "คุณตัดสินใจเลือกลงไปข้างล่างแทน- หากว่าเกิดเป็นโจรขึ้นบ้าน คุณมั่นใจว่าคงหนีสะดวกกว่าในพื้นที่โล่งตรงห้องรับแขก \nเมื่อก้าวลงมาจากบันไดขั้นสุดท้าย คุณมองสำรวจ เพื่อเลือกเส้นทางที่ตัวเองจะเดินหน้าต่อไป ... ",
        background : "",
        character: "",
        delay_character : 0,
        next: ""
    ...
    scare_1_cutscence: {
        text: "‘ห้องของบิดามารดาย่อมไม่ใช่สนามเด็กเล่น’ ทุกครั้งที่คุณถูกจับได้ คุณจะโดนทำโทษตั้งแต่เล็กน้อยจนมากขึ้นเรื่อย ๆ \nส่วนหนึ่งในร่างกายคุณจึงจดจำ คุณปรับสายตาเข้ากับความมืด \nฉับพลัน- คุณสังเกตเห็นเงาตะคุ่มบางอย่างที่มุมห้องอันมืดมิด สิ่งที่คล้ายปากฉีกยิ้มให้คุณ",
        background : "",
        next: "scare_2"
    },

    scare_2: {
        text: "ด้วยความตกใจสุดขีด คุณพุ่งตรงไปยังประตู กระแทกเปิดด้วยแรงทั้งหมดที่มี, \nตัวคุณถลาไปกับทางเดินหน้าห้อง สุดปลายสายตาคือห้องนอนของคุณ แม้ระหว่างทางจะถูกคั่นด้วยห้องพี่สาว แต่กลอนประตูกลับถูกล็อค \nบังคับคุณให้ไม่มีทางเลือกนอกจากวิ่งตรงไปข้างหน้า ...",
        background : "",
        character: "",
        delay_character : 0,
        next: "scare_3"
    ...
    scare_3: {
        text: "คุณสาวเท้าก้าวอย่างรีบร้อน ความกลัวกลั่นตัวเป็นหยดเหงื่อเย็น จนหยุดยืนอยู่หน้าบานประตู \nมือคุณที่กำลังเอื้อมหยุดค้างกลางอากาศ- ใบหูคุณได้ยินเสียงดังแว่วลอดผ่านช่องประตู มันดังมาจากข้างในนั้น \nทางเลือกคุณมีไม่เหลือแล้ว",
        background : "",
        character: "",
        delay_character : 0,
    ...
    scare_downstair: {
        text: "การเอาชนะความกลัวหลังจากผ่านเหตุการณ์ชวนขนหัวลุกนั้นเป็นเรื่องยากเกินไป คุณเลือกที่จะลงไปข้างล่างแทนที่จะฝืนแรงไปเปิดประตู \nลงมาจนสุดท้ายของขั้นบันได หากแต่ค่ำคืนนี้ยังไม่จบ มันยังเหลือเส้นทางให้คุณเลือกตัดสินใจอีกหลังจากนี้ ...",
        background : "",
        character: "",
        delay_character : 0,
        next: ""
...
function loadScene(scene){
    ...
    if (sceneData.character) {
        setTimeout(() => {
            characterBox.style.backgroundImage = `url(${sceneData.character})`;
            characterBox.style.display = "flex";
        }, sceneData.delay_character || 0);
  }
